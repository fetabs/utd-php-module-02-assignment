<?php 
  ...
  if(!isset($_SESSION[md5('user_data')])) {
    header("location: https://localhost/utd/index.php?error=forbidden");
  }
...
<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="index.html">Sistema de Usuários</a>
    <!-- Sidebar Toggle-->
                ...
                <tbody>
                  <?php foreach($data as $key => $dt): ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <form 
                          action="updateUser.php?id=<?= $key; ?>&token=<?= $token; ?>" 
                          method="POST"
                        >
      ...
      <footer class="py-4 bg-light mt-auto">
        <div class="container-fluid px-4">
          <div class="d-flex align-items-center justify-content-between small">
            <div class="text-muted">Copyright &copy; @fetabs 2023</div>
            <div>
